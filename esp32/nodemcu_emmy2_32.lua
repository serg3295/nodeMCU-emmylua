...
---@param callbackOnEvents? function @(optional) Your Lua method to call on `event.myfunction(unit, isThr0, isThr1, isLLim, isHLim, isZero)` will be called.
---Event will be
...
---@param config? SpiMaster @(optional) table listing the assigned GPIOs. All signal assignment are optional. **sclk, mosi, miso, quadwp, quadhd**
...
---@param ntpAddr? string @(optional) address of a NTP server, defaults to "pool.ntp.org" if none is specified
---@return nil
...
---@return table filter @A 2nd Lua table of touch sensor filtered counter values per pad is returned if filterMs is specified during the `touch.create()` method.
...
---If you set touch.TOUCH_TRIGGER_BELOW then the interrupt occurs when the touch counter\
---goes below this threshold value, or vice versa for touch.TOUCH_TRIGGER_ABOVE.
---@return nil
