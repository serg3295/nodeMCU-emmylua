...
---@return nil
function socket:connect(port, ip_or_domain) end

---Provides DNS resolution for a hostname.
---@param domain string @domain name
---@param callback fun(netsocket: socket, ip: string) @`function(net.socket, ip)`.
...
---@param callback fun(netsocket: socket, data_or_error: string|number)|nil @`function(net.socket[, string])`. Can be `nil` to remove callback.
...
---Provides DNS resolution for a hostname.
---@param domain string @domain name
---@param callback fun(netsocket: udpsocket, ip: string) @`function(net.udpsocket, ip)`.
---The first parameter is the socket, the second parameter is the IP address as a string.
---@return nil
