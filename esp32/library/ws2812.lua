...
---@class WS2812write
---@field pin integer IO index, see [GPIO Overview](gpio.md#gpio-overview)
---@field data any payload to be sent to one or more WS2812 like leds through GPIO2
---@field reset? integer duration of the reset signal in multiples of 100ns.
---@field t0h? integer duration of the high period for a 0 code in multiples of 100ns.
---@field t0l? integer duration of the low period for a 0 code in multiples of 100ns.
---@field t1h? integer duration of the high period for a 1 code in multiples of 100ns.
---@field t1l? integer duration of the low period for a 1 code in multiples of 100ns.
...
--- - **reset** (optional) duration of the reset signal in multiples of 100ns. A duration of 0 generates no reset.\
---The minimum possible value is 0. The maximum is 65534. The default value is 512 which generates a reset of 51.2us.
--- - **t0h** (optional) duration of the high period for a 0 code in multiples of 100ns.\
---The minimum possible value is 1. The maximum is 32767. The default value is 4 which results in a high period of 400ns for each 0 code.
--- - **t0l** (optional) duration of the low period for a 0 code in multiples of 100ns.\
---The minimum possible value is 1. The maximum is 32767. The default value is 7 which results in a low period of 700ns for each 0 code.
--- - **t1h** (optional) duration of the high period for a 1 code in multiples of 100ns.
---The minimum possible value is 1. The maximum is 32767. The default value is 8 which results in a high period of 800ns for each 1 code.
--- - **t1l** (optional) duration of the low period for a 1 code in multiples of 100ns.\
---The minimum possible value is 1. The maximum is 32767. The default value is 6 which results in a low period of 600ns for each 1 code.
---
...
---@return ws2812buffer @ws2812.buffer
---@nodiscard
...
---@return number @(color)
---@nodiscard
function ws2812buffer:get(index) end
...
---@return nil
function ws2812buffer:set(index, color) end

---Return the size of the buffer in number of leds
---@return integer
---@nodiscard
function ws2812buffer:size() end
...
---@return nil
function ws2812buffer:fill(color) end
...
---@nodiscard
function ws2812buffer:dump() end
...
---@return nil
function ws2812buffer:replace(source, offset) end
...
---@return nil
function ws2812buffer:fade(value, direction) end
...
---@return nil
function ws2812buffer:shift(value, mode, i, j) end
...
---@nodiscard
function ws2812buffer:sub(i, j) end
