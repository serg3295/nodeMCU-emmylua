...
---@param callback? function @(optional) the callback function to receive the advertising reports, or `nil` to deregister the callback. This callback receives the raw bytes of the advertisement payload.
---@return nil
...
---@param callback? function|nil|' function() end' @(optional) a function to be called when the given event occurs. Can be `nil` to remove a previously configured callback.
---@return nil
...
---@param callback? function @(optional) `function(data, ack)` to be called when transfer finished
---@param to_ms? integer @(optional) timeout for the transfer in ms, defaults to **0** (infinite)
---@return any|nil @>
...
---@param callback? function|' function(err, data) end' @(optional) `function(err, data)` to be called when data was received from the master. Unregisters previous callback for event when omitted.
---@return nil
...
---Creates a client.
---@param type? integer|'net.TCP' @(optional) `net.TCP` (default) or `net.UDP` There's no such thing as a UDP connection because UDP is connection*less*. Thus no connection `type` parameter should be required.
---@param secure? integer @(optional) 0 for plain (default). Secure connections are not supported, and the `secure` parameter is ignored. For UDP use `net.createUDPSocket()` instead.
---@return netsocket @>
...
---Creates a server.
---@param type? integer|'net.TCP' @(optional) The `type` parameter will be removed in upcoming releases so that `net.createServer` will always create a TCP-based server. For UDP use `net.createUDPSocket()` instead.
---@param timeout? integer @(optional) for a TCP server timeout is 1~28'800 seconds, 30 sec by default (for an inactive client to be disconnected)
---@return netsrv @>
...
---@param callback? function @(optional) `function` a compiled function to be stripped per setfenv except 0 is not permitted.
