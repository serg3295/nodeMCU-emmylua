...
---@class (exact) RmtConfigTx
---@field invert? boolean if `true`, then the output is inverted.
---@field carrier_hz? integer specifies that the signal is to modulate the carrier at the specified frequency.
...
---@field slots? integer If specified, then the number of memory slots used for transmission.

---@class (exact) RmtConfigRx
---@field invert? boolean if `true`, then the input is inverted.
---@field filter_ticks? integer If specified, then any pulse shorter than this will be ignored.
---@field idle_threshold? integer If specified, then any level longer than this will set the receiver as idle.
---@field slots? integer If specified, then the number of memory slots used for reception.
...
---@param options? RmtConfigTx @"(optional) A table with the keys as defined below. This optional table consists of a number of keys  \nthat control various aspects of the RMT transmission.""
...
---@return rmtChannel @The `rmt.channel` object that can be used for sending data
---@return integer @The actual bit time in picoseconds.
---@nodiscard
...
---@param options? RmtConfigRx @"(optional) A table with the keys as defined below. This optional table consists of a number of keys  \nthat control various aspects of the RMT transmission."
...
---@return rmtChannel @The `rmt.channel` object that can be used for receiving data
---@return integer @The actual bit time in picoseconds.
---@nodiscard
...
---@param event "data" @This must be the string 'data' and it sets the callback that gets invoked when data is received.
...
---@param data string|table<integer, string> @This is either a string or a table of strings.
